...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"name_country\": () => (/* binding */ name_country),\n/* harmony export */   \"fun_dom\": () => (/* binding */ fun_dom)\n/* harmony export */ });\n/* harmony import */ var _map_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../map/main */ \"./src/js/map/main.js\");\n/* harmony import */ var _map_save__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../map/save */ \"./src/js/map/save.js\");\n/* harmony import */ var _get_dom_id__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./get_dom_id */ \"./src/js/menu/get_dom_id.js\");\n\n\n\nconst raw = localStorage.getItem(\"player\");\nconst person = JSON.parse(raw);\nlet name_country;\nconst fun_dom = {\n  get_id: {\n    start_menu: document.getElementById(\"button_new_game\"),\n    create: document.getElementById(\"button_create_country\"),\n    about_developer_menu: document.getElementById(\"button_about_developer\"),\n    about_developer_back: document.getElementById(\"button_back_about_developer\"),\n    start_back: document.getElementById(\"button_back_start\"),\n    cnv_div_back: document.getElementById(\"button_back_cnv_div\"),\n    continue_game: document.getElementById(\"button_continue_game\"),\n    save_game_yes: document.getElementById('button_save_game_yes'),\n    save_game_no: document.getElementById('button_save_game_no')\n  },\n\n  check() {\n    this.get_id.continue_game.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.menu.style.display = 'none';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.cnv.style.display = 'block';\n\n      if (localStorage.getItem(\"player\")) {\n        _map_main__WEBPACK_IMPORTED_MODULE_0__.map.create();\n\n        for (let i = 0; i < _map_main__WEBPACK_IMPORTED_MODULE_0__.map.width[0] * _map_main__WEBPACK_IMPORTED_MODULE_0__.map.height[0]; i++) {\n          _map_main__WEBPACK_IMPORTED_MODULE_0__.map.array[i].x = person.map[i].x;\n          _map_main__WEBPACK_IMPORTED_MODULE_0__.map.array[i].y = person.map[i].y;\n        }\n\n        name_country = person.name_country;\n        _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.name_country.innerHTML = name_country;\n      }\n    });\n    this.get_id.start_menu.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.start_menu.style.display = 'block';\n    });\n    this.get_id.save_game_yes.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.save_game_menu.style.display = 'none';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.menu.style.display = 'block';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.cnv.style.display = 'none';\n      (0,_map_save__WEBPACK_IMPORTED_MODULE_1__.localStorageReturn)();\n    });\n    this.get_id.save_game_no.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.save_game_menu.style.display = 'none';\n    });\n    this.get_id.about_developer_back.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.about_developer_menu.style.display = 'none';\n    });\n    this.get_id.cnv_div_back.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.save_game_menu.style.display = 'block';\n    });\n    this.get_id.start_back.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.start_menu.style.display = 'none';\n    });\n    this.get_id.about_developer_menu.addEventListener('click', event => {\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.about_developer_menu.style.display = 'block';\n    });\n    this.get_id.create.addEventListener('click', event => {\n      name_country = document.getElementById('name_country_input').value;\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.start_menu.style.display = 'none';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.menu.style.display = 'none';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.cnv.style.display = 'block';\n      _get_dom_id__WEBPACK_IMPORTED_MODULE_2__.dom_id.name_country.innerHTML = name_country;\n      _map_main__WEBPACK_IMPORTED_MODULE_0__.map.create();\n      (0,_map_save__WEBPACK_IMPORTED_MODULE_1__.localStorageReturn)();\n    });\n  }\n\n};\n\n//# sourceURL=webpack://country/./src/js/menu/fun_dom.js?");
